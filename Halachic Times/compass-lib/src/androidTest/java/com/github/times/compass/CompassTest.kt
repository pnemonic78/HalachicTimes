...
class CompassTest {
    ...
    fun rotationMatrixPortrait0() {
        ...
        val matrixRExpected = floatArrayOf(0.8906765f, -0.0f, 0.45463768f, 0.45463768f, 0.0f, -0.8906765f, 0.0f, 1.0f, 0.0f)
        ...
        assertEquals((PI / -2).toFloat(), orientation[1])
    ...
    fun rotationMatrixLandscape270() {
        ...
        val matrixRExpected = floatArrayOf(0.0f, -0.8906765f, 0.45463768f, 0.0f, -0.45463768f, -0.8906765f, 1.0f, 0.0f, 0.0f)
        ...
        assertEquals((PI / -2).toFloat(), orientation[2])
    }
    ...
    fun rotationMatrixPortrait0_LG() {
        ...
        val matrixRExpected = floatArrayOf(-0.3933655f, -0.9177463f, -0.05481959f, 0.91931605f, -0.39335173f, -0.011494861f, -0.011014016f, -0.054918222f, 0.9984301f)
    ...
    fun rotationMatrixLandscape90_LG() {
        ...
        val matrixRExpected = floatArrayOf(-0.47574702f, -0.8777499f, -0.056743126f, 0.8794898f, -0.47564095f, -0.016228417f, -0.012744861f, -0.05762562f, 0.9982569f)
        val mapRExpected = floatArrayOf(0.8777499f, -0.47574702f, -0.056743126f, 0.47564095f, 0.8794898f, -0.016228417f, 0.05762562f, -0.012744861f, 0.9982569f)
    ...
    fun rotationMatrixLandscape180_LG() {
        ...
        val matrixRExpected = floatArrayOf(-0.81935644f, -0.5714123f, -0.046292763f, 0.5730808f, -0.8185428f, -0.039574735f, -0.015279113f, -0.058955304f, 0.9981437f)
        val mapRExpected = floatArrayOf(-0.81935644f, 0.5714123f, 0.046292763f, 0.5730808f, 0.8185428f, 0.039574735f, -0.015279113f, 0.058955304f, -0.9981437f)
    ...
    fun rotationMatrixLandscape270_LG() {
        ...
        val matrixRExpected = floatArrayOf(-0.32009178f, -0.94540405f, -0.061257623f, 0.9472406f, -0.32050735f, -0.0031830538f, -0.016624246f, -0.059044573f, 0.9981168f)
        val mapRExpected = floatArrayOf(-0.94540405f, 0.32009178f, -0.061257623f, -0.32050735f, -0.9472406f, -0.0031830538f, -0.059044573f, 0.016624246f, 0.9981168f)
