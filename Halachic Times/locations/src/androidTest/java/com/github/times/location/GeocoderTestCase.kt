...
class GeocoderTestCase {
    ...
    fun testGoogleAddress() {
        ...
        assertEquals("1, Kalischer St, Holon, Center District, Israel", (address as ZmanimAddress?)!!.formatted)
        ...
        assertEquals("Unnamed Road, Rosh Haayin, Petach Tikva, Center District, Israel", (address as ZmanimAddress?)!!.formatted)
        ...
        assertEquals("331, Bar Yohai, Tzfat, North District, Israel", (address as ZmanimAddress?)!!.formatted)
    ...
    fun testBingAddress() {
        ...
        assertEquals("Shenkar Arye, Holon, Tel-Aviv, Tel Aviv, Israel", (address as ZmanimAddress).formatted)
        ...
        assertEquals("Orlov Ze'Ev & Bar Kokhva, Petah Tikva, Merkaz, Israel", (address as ZmanimAddress).formatted)
    }
    ...
    fun testInternalGeocoderAddress() {
        ...
        assertEquals("331, Bar Yohai, Tzfat, North District, Israel", zmanimAddress.formatted)
    }
