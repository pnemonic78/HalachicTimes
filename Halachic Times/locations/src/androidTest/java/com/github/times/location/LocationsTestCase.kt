...
class LocationsTestCase {
     ...
     *
     *
     * Loop through all TZs and check that their longitude and latitude are valid.
     */
    @Test
    fun testTZ() {
        val app = application
    ...
    fun testParseLatitudeDecimal() {
        ...
        val formatter = SimpleLocationFormatter(context, LocationPreferences.Values.FORMAT_DECIMAL, true)
    ...
    fun testParseLatitudeSexagecimal() {
        ...
        val formatter = SimpleLocationFormatter(context, LocationPreferences.Values.FORMAT_SEXAGESIMAL, true)
        assertTrue(formatter.parseLatitude("").isNaN())
        assertTrue(formatter.parseLatitude("a").isNaN())
        assertTrue(formatter.parseLatitude("\u00B0").isNaN())
