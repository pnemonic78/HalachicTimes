...
import static net.sf.times.location.LocationPreferences.Values.ELEVATION_VISIBLE_DEFAULT;
import static net.sf.times.location.LocationPreferences.Values.FORMAT_DECIMAL;
import static net.sf.times.location.LocationPreferences.Values.FORMAT_DEFAULT;
import static net.sf.times.location.LocationPreferences.Values.FORMAT_NONE;
