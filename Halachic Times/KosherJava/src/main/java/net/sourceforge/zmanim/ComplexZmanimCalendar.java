...
public class ComplexZmanimCalendar extends ZmanimCalendar {
	 ...
	 *
	 * @return the date representing the exact sea-level <em>netz amiti</em> (sunrise) time. If the calculation can't be computed
	 *         such as in the Arctic Circle where there is at least one day a year where the sun does not rise, and one
	 ...
	 * For further explanation see <a href="https://www.chabad.org/library/article_cdo/aid/3209349/jewish/About-Our-Zmanim-Calculations.htm">Chabad.org</a>
	 *
	 * @return the date representing the exact sea-level <em>shkiah amiti</em> (sunset) time. If the calculation can't be computed
	 *         such as in the Arctic Circle where there is at least one day a year where the sun does not rise, and one
	 *         where it does not set, a null will be returned. See detailed explanation on top of the page.
