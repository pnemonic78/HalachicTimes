...
import com.github.location.Location.Companion.ELEVATION_MAX
import com.github.location.Location.Companion.ELEVATION_MIN
...
class TextElevationResponseParser : ElevationResponseParser() {
    ...
    private fun toLocation(response: String, latitude: Double, longitude: Double): Location? {
        return try {
            ...
            if (elevation <= ELEVATION_LOWEST_SURFACE) {
                //TODO Timber.w("elevation too low: %s", response)
                return null
            }
            if (elevation >= ELEVATION_SPACE) {
                //TODO Timber.w("elevation too high: %s", response)
                return null
            }
            ...
            //TODO Timber.e(e, "Bad elevation: [$response] at $latitude,$longitude")
    ...
    companion object {
         ...
         */
        private const val ELEVATION_LOWEST_SURFACE = ELEVATION_MIN

        /**
         * Highest possible natural elevation from the surface of the earth.
         */
        private const val ELEVATION_SPACE = ELEVATION_MAX
    }
}